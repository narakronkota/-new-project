...
const AddRoommm = () => {
  ...
  return (
    ...
    <form >
          <Title align='left' font='outfit' title='ADD ROOM' subTitle='Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi cupiditate quas tempore fuga nobis nesciunt ipsam reiciendis repellendus! Doloribus nemo libero modi, voluptate quos error eligendi alias molestias ab adipisci.'/>
           {/*****upload images */}
            <p className='text-gray-800 mt-10'>Images</p>
            <div className='rid grid-cols2 sm:flex gap-4 my-2 flex-wrap'>
          ...
          <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
           {Object.keys(inputs.amennities).map((amenity, index)=>(
            <div key={index}>
                <input type="checkbox" id={`amennities${index+1}`} checked = {inputs.amennities[amenity]} onChange={()=>setInputs({...inputs,amennities: {...inputs.amennities,[amenity]: ! inputs.amennities[amenity]}})} />
