...
const BookIcon = ()=>(
    <svg className="w-4 h-4 text-grey-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24 ">
        <path  stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"strokeWidth="2" d="M5 19V4a1 1 0 0 1 1-h12a1 1 0 0 1 1 1v13H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4" />
    </svg>
)
...
const Navbar = () => {
    ...
    return (
        ...
        <div className="hidden md:flex items-center gap-4">
            <img src={assets.searchIcon} alt="Serch" className={`${isScrolled && 'invert'} h-7 transition-all duration-500`} />
